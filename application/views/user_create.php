...
<p class="form_top_dashed">
     ...
     <div class="form_help_text">Your username can be anything you like (minimum three characters).  It does not need to be your SUNet ID
(although your SUNet ID is fine too).  Keep in mind your comments on this site may be seen by the rest of
...
<p>
     ...
     <div class="form_help_text">This will be your password for the CS248B website.</div>
...
<p>
     ...
     <div><input type="input" class="form_input_box" name="sunetid"></div>
     </p>
<p>
