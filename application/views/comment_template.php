...
<?php $use_prompt = false; $use_archive = false; $use_vote = false; $use_edit_reason = false; $use_edit = true; $use_history = false; ?>

<div class="comment"
     data-id="<?php echo $comment->id ?>"
<?php if ($use_vote && isset($comment->current_user_vote)) { ?>
...
>
    ...
    <div class="comment-data">
        <?= $comment->body_html ?>
<?php if ($use_edit_reason && $is_privileged && $comment->edit_reason) { ?>
...
<?php if ($use_edit_reason && $comment->state === REVISED) { ?>
            Edit reason:
...
<?php if ($use_vote && $is_privileged || $logged_in_group === UPDOWNVOTE_GROUP) { ?>
