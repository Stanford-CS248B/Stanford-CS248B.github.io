...
class Lecture extends MY_Controller {
    ...
    function do_create()
    {
        ...
        // file_put_contents('mylog.txt', $this->config->item('content_base_path').'/'.$this->config->item('uploads_rel_path').'0 '.realpath($this->config->item('content_base_path').'/'.$this->config->item('uploads_rel_path')).'1');
